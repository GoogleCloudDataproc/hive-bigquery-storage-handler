...
public class HiveBigQueryStorageHandler  extends DefaultStorageHandler {
    ...
    public void configureInputJobProperties(TableDesc tableDesc, Map<String, String> jobProperties) {
        ...
        LOG.info("Configuring MapReduce Job Input Properties  (if not provided) from Hive Table properties ");

        ImmutableMap<String,String> inputConfigurations = ImmutableMap.of(
    ...
    public void configureOutputJobProperties(TableDesc tableDesc, Map<String, String> jobProperties) {
        ...
        LOG.info("Configuring MapReduce Job Output Properties  (if not provided) from Hive Table properties ");

        ImmutableMap<String,String> outputConfigurations = ImmutableMap.of(
                BigQueryConfiguration.OUTPUT_PROJECT_ID_KEY ,  BigQueryConfiguration.PROJECT_ID_KEY,
                BigQueryConfiguration.OUTPUT_DATASET_ID_KEY ,  HiveBigQueryConstants.DEFAULT_BIGQUERY_DATASET_KEY,
                BigQueryConfiguration.OUTPUT_TABLE_ID_KEY ,  HiveBigQueryConstants.DEFAULT_BIGQUERY_TABLE_KEY
        );
    ...
    public void configureJobConf(TableDesc tableDesc, JobConf jobConf) {
        ...
        ImmutableList<String> propertyNames = ImmutableList.of(BigQueryConfiguration.TEMP_GCS_PATH_KEY
